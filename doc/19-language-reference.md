...
[Apply](19-language-reference.md#apply) rules can be extended with the
[for loop](19-language-reference.md#for-loops) keyword.
...
[library reference](20-library-reference.md#library-reference).
